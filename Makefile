...
#*   Updated: 2016/03/03 14:35:10 by nahmed-m         ###   ########.fr       *#
#                                                                              #
# **************************************************************************** #

SRC_NAME = main.c parsing.c control.c utils.c print_mode.c print_link.c print_usr_grp.c print_size.c print_time.c sort.c file_or_dir.c
